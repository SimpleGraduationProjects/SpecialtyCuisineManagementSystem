  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 0, 0, 1);fontSize:28px;">特色美食网站注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.juzhudi" class="input" type="text" placeholder="居住地">
			   </div>
			 </div> -->
			<el-form-item label="居住地" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.juzhudi" autocomplete="off" placeholder="居住地" type="text" />
			</el-form-item>
