...
{
	name: '地区美食',
	url: './pages/diqumeishi/list.html'
}, 
{
	name: '美食文化',
	url: './pages/meishiwenhua/list.html'
}, 
...
var adminurl =  "http://localhost:8080/springbooti7ju1/admin/dist/index.html";
